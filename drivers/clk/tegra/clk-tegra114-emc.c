...
struct tegra_clk_emc {
	...
	tegra114_emc_prepare_timing_change_cb *prepare_timing_change;
	tegra114_emc_complete_timing_change_cb *complete_timing_change;
};
...
EXPORT_SYMBOL_GPL(tegra114_clk_set_emc_callbacks);

bool tegra114_clk_emc_driver_available(struct clk_hw *hw)
{
